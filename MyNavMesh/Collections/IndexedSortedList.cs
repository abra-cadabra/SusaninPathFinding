...
namespace MyNavMesh.Collections
{
    /// <summary>
    ...
    /// </item><item>
    /// <see cref="IndexedSortedList{TKey, TValue}.AsReadOnly"/> returns a read-only wrapper that has the
    ...
    /// </item><item>
    /// <see cref="IndexedSortedList{TKey, TValue}.Copy"/> creates a deep copy of the collection by
    ...
    /// </item><item>
    /// <see cref="IndexedSortedList{TKey, TValue}.Empty"/> returns an immutable empty collection that is
    /// cached for repeated access.
    /// </item><item>
    /// <see cref="IndexedSortedList{TKey, TValue}.Equals"/> compares two collections with identical
    /// element types for value equality of all elements. The collections compare as equal if they
    /// contain the same elements in the same order.
    /// </item><item>
    /// <see cref="IndexedSortedList{TKey, TValue}.GetByIndex"/>, <see cref="IndexedSortedList{TKey,
    /// TValue}.GetKey"/>, and <see cref="IndexedSortedList{TKey, TValue}.SetByIndex"/> are adopted from
    ...
    [Serializable]
    public class IndexedSortedList<TKey, TValue>// : IDictionary<TKey, TValue>, IDictionary, ICloneable
    {

        // TODO: Implement IndexedSortedList class
        ...
        ///// cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ...
        ///// <summary>
        ///// The read-only <see cref="IndexedSortedList{TKey, TValue}"/> collection that is returned by
        ///// the <see cref="AsReadOnly"/> method.</summary>

        //protected IndexedSortedList<TKey, TValue> ReadOnlyWrapper;
        ...
        ///// <overloads>
        ///// Initializes a new instance of the <see cref="IndexedSortedList{TKey, TValue}"/> class.
        ///// </overloads>
        ///// <summary>
        ///// Initializes a new instance of the <see cref="IndexedSortedList{TKey, TValue}"/> class that is
        ...
        //#endregion
        //#region IndexedSortedList(IComparer<TKey>)
        ...
        //public IndexedSortedList(IComparer<TKey> comparer)
        //{
        //    InnerDictionary = new SortedList<TKey, TValue>(comparer);
        //}

        //#endregion
        //#region IndexedSortedList(IDictionary<TKey, TValue>)

        ///// <summary>
        ///// Initializes a new instance of the <see cref="IndexedSortedList{TKey, TValue}"/> class that
        ...
        //#endregion
        //#region IndexedSortedList(IDictionary<TKey, TValue>, IComparer<TKey>)
        ...
        //public IndexedSortedList(IDictionary<TKey, TValue> dictionary, IComparer<TKey> comparer) {
        //    if (dictionary == null)
        //        ThrowHelper.ThrowArgumentNullException("dictionary");
        ...
        //#endregion
        //#region IndexedSortedList(Int32)
        ...
        ///// <typeparamref name="TKey"/>.</summary>
        ///// <param name="capacity">
        ///// The number of elements that the new <see cref="IndexedSortedList{TKey, TValue}"/> is
        ...
        //public IndexedSortedList(int capacity) {
        //    InnerDictionary = new SortedList<TKey, TValue>(capacity);
        //}

        //#endregion
        //#region IndexedSortedList(Int32, IComparer<TKey>)
        ...
        //public IndexedSortedList(int capacity, IComparer<TKey> comparer) {
        //    InnerDictionary = new SortedList<TKey, TValue>(capacity, comparer);
        //}

        //#endregion
        //#region IndexedSortedList(IndexedSortedList<TKey, TValue>, Boolean)
        ...
        //protected IndexedSortedList(IndexedSortedList<TKey, TValue> dictionary, bool readOnly) {
        //    if (dictionary == null)
        //        ThrowHelper.ThrowArgumentNullException("dictionary");
        ...
        ///// <summary>
        ///// An empty read-only <see cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <remarks>
        ...
        //public static readonly IndexedSortedList<TKey, TValue> Empty =
        //    new IndexedSortedList<TKey, TValue>(0).AsReadOnly();
        ...
        ///// <summary>
        ///// Gets or sets the capacity of the <see cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <value>
        ///// The number of elements that the <see cref="IndexedSortedList{TKey, TValue}"/> can contain.
        ///// </value>
        ///// <exception cref="ArgumentOutOfRangeException">
        ///// The property is set to a value that is less than <see cref="Count"/>.</exception>
        ///// <exception cref="NotSupportedException">
        ///// The property is set, and the <see cref="IndexedSortedList{TKey, TValue}"/> is read-only.
        ///// </exception>
        ///// <remarks>
        ...
        ///// keys in the <see cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <value>
        ...
        ///// <summary>
        ///// Gets the number of key-and-value pairs contained in the <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>.</summary>
        ///// <value>
        ///// The number of <see cref="KeyValuePair{TKey, TValue}"/> elements contained in the <see
        ///// cref="IndexedSortedList{TKey, TValue}"/>.</value>
        ///// <remarks>
        ...
        ///// <summary>
        ///// Gets a value indicating whether the <see cref="IndexedSortedList{TKey, TValue}"/> has a fixed
        ///// size.</summary>
        ///// <value>
        ///// <c>true</c> if the <see cref="IndexedSortedList{TKey, TValue}"/> has a fixed size; otherwise,
        ...
        ///// since any fixed-size <see cref="IndexedSortedList{TKey, TValue}"/> is also read-only, and
        ...
        ///// <summary>
        ///// Gets a value indicating whether the <see cref="IndexedSortedList{TKey, TValue}"/> is
        ///// read-only.</summary>
        ///// <value>
        ///// <c>true</c> if the <see cref="IndexedSortedList{TKey, TValue}"/> is read-only; otherwise,
        ///// <c>false</c>. The default is <c>false</c>.</value>
        ///// <remarks>
        ...
        ///// <summary>
        ///// Gets a value indicating whether access to the <see cref="IndexedSortedList{TKey, TValue}"/>
        ///// is synchronized (thread-safe).</summary>
        ///// <value>
        ///// <c>true</c> if access to the <see cref="IndexedSortedList{TKey, TValue}"/> is synchronized
        ...
        ///// specified key and value to the <see cref="IndexedSortedList{TKey, TValue}"/>.</para></value>
        ///// <exception cref="ArgumentNullException">
        ...
        ///// cref="IndexedSortedList{TKey, TValue}"/>.</exception>
        ///// <exception cref="NotSupportedException">
        ///// The property is set, and the <see cref="IndexedSortedList{TKey, TValue}"/> is read-only.
        ///// </exception>
        ///// <remarks>
        ...
        ///// <summary>
        ///// Gets a collection containing the keys in the <see cref="IndexedSortedList{TKey, TValue}"/>.
        ///// </summary>
        ///// <value>
        ...
        ///// cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <value>
        ///// An object that can be used to synchronize access to the <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>.</value>
        ///// <remarks><para>
        ///// Please refer to <see cref="ICollection.SyncRoot"/> for details.
        ///// </para><para>
        ///// When synchronizing multi-threaded access to the <see cref="IndexedSortedList{TKey,
        ...
        ///// <summary>
        ///// Gets a collection containing the values in the <see cref="IndexedSortedList{TKey, TValue}"/>.
        ///// </summary>
        ///// <value>
        ...
        ///// <overloads>
        ///// Adds the specified element to the <see cref="IndexedSortedList{TKey, TValue}"/>.</overloads>
        ///// <summary>
        ///// Adds the specified key and value to the <see cref="IndexedSortedList{TKey, TValue}"/>.
        ///// </summary>
        ///// <param name="key">
        ...
        ///// <exception cref="ArgumentException">
        ///// <paramref name="key"/> already exists in the <see cref="IndexedSortedList{TKey, TValue}"/>.
        ///// </exception>
        ///// <exception cref="ArgumentNullException">
        ///// <paramref name="key"/> is a null reference.</exception>
        ///// <exception cref="KeyMismatchException">
        ...
        ///// <exception cref="NotSupportedException">
        ///// The <see cref="IndexedSortedList{TKey, TValue}"/> is read-only.</exception>
        ///// <remarks>
        ...
        ///// <summary>
        ///// Adds the specified key-and-value pair to the <see cref="IndexedSortedList{TKey, TValue}"/>.
        ///// </summary>
        ///// <param name="pair">
        ...
        ///// already exists in the <see cref="IndexedSortedList{TKey, TValue}"/>.</exception>
        ///// <exception cref="ArgumentNullException">
        ...
        ///// <summary>
        ///// Adds the elements of the specified collection to the <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>. </summary>
        ///// <param name="dictionary">
        ...
        ///// The <see cref="IndexedSortedList{TKey, TValue}"/> is read-only.
        ///// </para><para>-or-</para><para>
        ///// The <see cref="IndexedSortedList{TKey, TValue}"/> already contains one or more keys in the
        ...
        ///// <summary>
        ///// Returns a read-only view of the <see cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <returns>
        ///// A read-only wrapper around the <see cref="IndexedSortedList{TKey, TValue}"/>.</returns>
        ///// <remarks><para>
        ...
        //public IndexedSortedList<TKey, TValue> AsReadOnly()
        //{

        //    if (ReadOnlyWrapper == null)
        //        ReadOnlyWrapper = new IndexedSortedList<TKey, TValue>(this, true);
        ...
        ///// <summary>
        ///// Removes all elements from the <see cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <exception cref="NotSupportedException">
        ///// The <see cref="IndexedSortedList{TKey, TValue}"/> is read-only.</exception>
        ///// <remarks>
        ...
        ///// <summary>
        ///// Creates a shallow copy of the <see cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <returns>
        ///// A shallow copy of the <see cref="IndexedSortedList{TKey, TValue}"/>.</returns>
        ///// <remarks>
        ...
        //{
        //    return new IndexedSortedList<TKey, TValue>(this);
        //}
        ...
        ///// <summary>
        ///// Determines whether the <see cref="IndexedSortedList{TKey, TValue}"/> contains the specified
        ///// key-and-value pair.</summary>
        ///// <param name="pair">
        ///// The <see cref="KeyValuePair{TKey, TValue}"/> element to locate.</param>
        ///// <returns>
        ///// <c>true</c> if <paramref name="pair"/> is found in the <see cref="IndexedSortedList{TKey,
        ...
        ///// <returns>
        ///// <c>true</c> if the <see cref="IndexedSortedList{TKey, TValue}"/> contains an element with the
        ...
        ///// <summary>
        ///// Creates a deep copy of the <see cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <returns>
        ///// A deep copy of the <see cref="IndexedSortedList{TKey, TValue}"/>.</returns>
        ///// <exception cref="InvalidCastException">
        ...
        ///// cref="IndexedSortedList{TKey, TValue}"/> by invoking <see cref="ICloneable.Clone"/> on all 
        ...
        //public IndexedSortedList<TKey, TValue> Copy()
        //{
        //    IndexedSortedList<TKey, TValue> copy = new IndexedSortedList<TKey, TValue>(Count);
        ...
        ///// <summary>
        ///// Copies the entire <see cref="IndexedSortedList{TKey, TValue}"/> to a one-dimensional <see
        ...
        ///// cref="IndexedSortedList{TKey, TValue}"/>. The <b>Array</b> must have zero-based indexing.
        ///// </param>
        ...
        ///// name="array"/>.
        ///// </para><para>-or-</para><para>
        ///// The number of elements in the source <see cref="IndexedSortedList{TKey, TValue}"/> is greater
        ...
        ///// same order as the current <see cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <param name="collection">
        ///// The <see cref="ICollection{T}"/> of <see cref="KeyValuePair{TKey, TValue}"/> elements to
        ///// compare with the current <see cref="IndexedSortedList{TKey, TValue}"/>.</param>
        ///// <returns><para>
        ///// <c>true</c> under the following conditions, otherwise <c>false</c>:
        ///// </para><list type="bullet"><item>
        ///// <paramref name="collection"/> is another reference to this <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>.
        ///// </item><item>
        ///// <paramref name="collection"/> is not a null reference, contains the same number of
        ///// elements as this <see cref="IndexedSortedList{TKey, TValue}"/>, and all elements compare as
        ...
        ///// <returns>
        ///// The value at the specified <paramref name="index"/> in the <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>.</returns>
        ///// <exception cref="ArgumentOutOfRangeException"><para>
        ///// <paramref name="index"/> is less than zero. 
        ///// </para><para>-or-</para><para>
        ///// <paramref name="index"/> is equal to or greater than <see cref="IndexedSortedList{TKey,
        ...
        ///// cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <returns>
        ///// An <see cref="IEnumerator{T}"/> for the entire <see cref="IndexedSortedList{TKey, TValue}"/>.
        ...
        ///// cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <returns>
        ///// An <see cref="IDictionaryEnumerator"/> for the entire <see cref="IndexedSortedList{TKey,
        ...
        ///// cref="IndexedSortedList{TKey, TValue}"/>.</summary>
        ///// <returns>
        ///// An <see cref="IEnumerator"/> for the entire <see cref="IndexedSortedList{TKey, TValue}"/>.
        ///// Each enumerated item is a <see cref="KeyValuePair{TKey, TValue}"/>.</returns>
        ...
        ///// <returns>
        ///// The key at the specified <paramref name="index"/> in the <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>.</returns>
        ///// <exception cref="ArgumentOutOfRangeException"><para>
        ///// <paramref name="index"/> is less than zero. 
        ///// </para><para>-or-</para><para>
        ...
        ///// cref="IndexedSortedList{TKey, TValue}"/>, if found; otherwise, -1.</returns>
        ///// <exception cref="ArgumentNullException">
        ///// <paramref name="key"/> is a null reference.</exception>
        ///// <remarks>
        ...
        ///// <overloads>
        ///// Removes the specified element from the <see cref="IndexedSortedList{TKey, TValue}"/>.
        ///// </overloads>
        ///// <summary>
        ///// Removes the element with the specified key from the <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>.</summary>
        ///// <param name="key">
        ...
        ///// <summary>
        ///// Removes the specified key-and-value pair from the <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>.</summary>
        ///// <param name="pair">
        ...
        ///// <summary>
        ///// Removes the element at the specified index in the <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>.</summary>
        ///// <param name="index">
        ...
        ///// cref="IndexedSortedList{TKey, TValue}"/>.</param>
        ///// <exception cref="ArgumentOutOfRangeException"><para>
        ///// <paramref name="index"/> is less than zero. 
        ///// </para><para>-or-</para><para>
        ///// <paramref name="index"/> is equal to or greater than <see cref="IndexedSortedList{TKey,
        ...
        ///// <summary>
        ///// Copies the key-and-value pairs of the <see cref="IndexedSortedList{TKey, TValue}"/> to a new
        ///// <see cref="Array"/>.</summary>
        ///// <returns>
        ///// A one-dimensional <see cref="Array"/> containing copies of the <see
        ///// cref="KeyValuePair{TKey, TValue}"/> elements of the <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>.</returns>
        ///// <remarks>
        ...
        ///// <summary>
        ///// Sets the capacity to the actual number of elements in the <see cref="IndexedSortedList{TKey,
        ///// TValue}"/>.
        ///// </summary>
        ///// <exception cref="NotSupportedException">
        ///// The <see cref="IndexedSortedList{TKey, TValue}"/> is read-only.</exception>
