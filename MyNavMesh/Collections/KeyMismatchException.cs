...
{
    /// <summary>
    /// The exception that is thrown when dictionary and <see cref="Tektosyne.Collections.IKeyedValue{TKey}"/> keys are
    /// mismatched.</summary>
    /// <remarks><para>
    /// <b>KeyMismatchException</b> extends the <see cref="InvalidOperationException"/> class with
    /// two additional properties, <see cref="Tektosyne.Collections.KeyMismatchException.Key"/> and <see
    /// cref="Tektosyne.Collections.KeyMismatchException.ValueKey"/>, holding the mismatched key values that caused the
    /// exception.
    /// </para><para>
    ...
    /// cref="Tektosyne.Collections.IKeyedValue{TKey}"/> instance with a dictionary <see cref="KeyValuePair{TKey,
    /// TValue}.Key"/> that differs from the object’s own <see cref="Tektosyne.Collections.IKeyedValue{TKey}.Key"/>.
    /// </para></remarks>
    ...
    public class KeyMismatchException : InvalidOperationException
    {
        ...
        /// <overloads>
        /// Initializes a new instance of the <see cref="Tektosyne.Collections.KeyMismatchException"/> class.</overloads>
        /// <summary>
        /// Initializes a new instance of the <see cref="Tektosyne.Collections.KeyMismatchException"/> class with default
        /// properties.</summary>
        /// <remarks><para>
        /// The following table shows the initial property values for the new instance of <see
        /// cref="Tektosyne.Collections.KeyMismatchException"/>:
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Tektosyne.Collections.KeyMismatchException"/> class with the
        ...
        /// <param name="valueKey">
        /// The <see cref="Tektosyne.Collections.IKeyedValue{TKey}.Key"/> that was found or stored in an <see
        /// cref="Tektosyne.Collections.IKeyedValue{TKey}"/> instance associated with <paramref name="key"/>.</param>
        /// <remarks><para>
        /// The following table shows the initial property values for the new instance of <see
        /// cref="Tektosyne.Collections.KeyMismatchException"/>:
        /// </para><list type="table"><listheader>
        ...
        /// cref="Tektosyne.Collections.KeyMismatchException"/>.</summary>
        /// <param name="message">
        /// The error message that specifies the reason for the exception.</param>
        /// <param name="innerException">
        /// The previous <see cref="Exception"/> that is the cause of the current <see
        /// cref="Tektosyne.Collections.KeyMismatchException"/>.</param>
        /// <remarks><para>
        /// The following table shows the initial property values for the new instance of <see
        /// cref="Tektosyne.Collections.KeyMismatchException"/>:
        /// </para><list type="table"><listheader>
        ...
        /// TValue}"/> that caused the <see cref="Tektosyne.Collections.KeyMismatchException"/>.</value>
        ...
        /// <summary>
        /// Gets the <see cref="Tektosyne.Collections.IKeyedValue{TKey}"/> key that caused the exception.</summary>
        /// <value>
        /// The <see cref="Tektosyne.Collections.IKeyedValue{TKey}.Key"/> of an <see cref="Tektosyne.Collections.IKeyedValue{TKey}"/> instance
        /// that caused the <see cref="Tektosyne.Collections.KeyMismatchException"/>.</value>
        ...
        /// the <see cref="Tektosyne.Collections.KeyMismatchException"/>.</param>
        /// <param name="context">
        /// A <see cref="StreamingContext"/> object containing contextual information about the
        /// source or destination.</param>
        /// <exception cref="ArgumentNullException">
