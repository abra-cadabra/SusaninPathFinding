...
namespace SusaninPathFinding.Collections
{
    ...
    public class ArrayEx<T> : IList<T>, IList, ICloneable
    {
        ...
        //    if (!readOnly)
        //    {
        //        string message = String.Format(CultureInfo.CurrentCulture, Strings.ArgumentEquals, false);
        //        throw new ArgumentException(message, "readOnly");
        //    }
        ...
        //{
        //    [DebuggerStepThrough]
        //    get { return GetValue((int)v.X, (int)v.Y, (int)v.Z); }
        //    [DebuggerStepThrough]
        //    set { SetValue(value, (int)v.X, (int)v.Y, (int)v.Z); }
        //}
        ...
        //    {
        //        string message = String.Format(CultureInfo.CurrentCulture, Strings.ArgumentLessOrGreater, 0, Length - 1);
        ...
        //    if (Rank != 2)
        //    {
        //        string message = String.Format(CultureInfo.CurrentCulture, Strings.PropertyNotValue, 2);
        //        throw new PropertyValueException("Rank", Rank, message);
        //    }
        ...
        //    if (i < 0 || i >= length0)
        //    {
        //        string message = String.Format(CultureInfo.CurrentCulture, Strings.ArgumentLessOrGreater, 0, length0 - 1);
        //        throw new ArgumentOutOfRangeException("i", i, message);
        //    }

        //    if (j < 0 || j >= length1)
        //    {
        //        string message = String.Format(CultureInfo.CurrentCulture, Strings.ArgumentLessOrGreater, 0, length1 - 1);
        //        throw new ArgumentOutOfRangeException("j", j, message);
        //    }
        ...
        //    if (Rank != 3)
        //    {
        //        string message = String.Format(CultureInfo.CurrentCulture, Strings.PropertyNotValue, 3);
        //        throw new PropertyValueException("Rank", Rank, message);
        //    }
        ...
        //    if (k < 0 || k >= length2)
        //    {
        //        string message = String.Format(CultureInfo.CurrentCulture, Strings.ArgumentLessOrGreater, 0, length2 - 1);
        //        throw new ArgumentOutOfRangeException("k", k, message);
        //    }
        ...
        //    {
        //        string message = String.Format(CultureInfo.CurrentCulture, Strings.ArgumentPropertyConflict, "Rank");
        ...
        //        {
        //            string message = String.Format(CultureInfo.CurrentCulture, Strings.ArgumentLessOrGreater, 0, currentLength - 1);
        //            throw new ArgumentOutOfRangeException("indices", indices, message);
        //        }
        ...
        public int GetIndex(int index)
        {
            ...
            {
                string message = String.Format(CultureInfo.CurrentCulture, Strings.ArgumentLessOrGreater, 0, Count - 1);
                throw new ArgumentOutOfRangeException("index", index, message);
            }
        ...
        public int GetIndex(int i, int j, int k)
        {
            ...
            return k * length1 * length0 + j * length0 + i;//(i * length1 + j) * length2 + k;
        }
        ...
        public T this[int x, int y]
        {
            get
            {
                ...
                return InnerArray[GetIndex(x, y)];
            }
            set { InnerArray[GetIndex(x, y)] = value; }
        }
        ...
        public T this[int x, int y, int z]
        {
            get
            {
                ...
                return InnerArray[GetIndex(x, y, z)];
            }
            set { InnerArray[GetIndex(x, y, z)] = value; }
        }
        #endregion
