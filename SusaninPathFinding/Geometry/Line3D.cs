...
namespace SusaninPathFinding.Geometry
{
    ...
    {
        // TODO: Implement a Line3D class

        //#region LineD(Double, Double, Double, Double, Double, Double)
        ...
        //        Vector3 v1 = new Vector3(End.X - Start.X, End.Y - Start.Y, End.Z - Start.Z);
        ...
        //        double xyProj = Math.Sqrt(x * x + y * y);
        //        return Math.Sqrt(xyProj * xyProj + z * z);
        //    }
        //}
        ...
        //{
        //    get { return new Vector3(End.X - Start.X, End.Y - Start.Y, End.Z - Start.Z); }
        //}
        ...
        //public double DistanceSquared(Vector3 q)
        //{
        //    //TODO: Write it properly for 3D line
        //    if (q == Start || q == End) return 0;

        //    double x = Start.X, y = Start.Y, z = Start.Z;
        //    double ax = End.X - x, ay = End.Y - y, az = End.Z - z;

        //    // set (x,y,z) to nearest Line3D point from q
        //    if (ax != 0 || ay != 0 || az != 0)
        //    {
        ...
        /////// <summary>
        /////// Converts the specified collections of <see cref="Vector3"/> coordinates and zero-based
        /////// indices into the equivalent <see cref="Line3D"/> instances.</summary>
        /////// <param name="points">
        ...
        ////public static Line3D[] FromIndexPoints(Vector3[] points, Vector3[] indices)
        ////{
        ////    if (points == null)
        ...
        ////    Line3D[] lines = new Line3D[indices.Length];

        ////    for (int i = 0; i < indices.Length; i++)
        ////        lines[i] = new Line3D(points[indices[i].X], points[indices[i].Y]);
