...
namespace SusaninPathFinding.Graph
{
    ...
    {
        // TODO: Implement a Polygon3D class
        ...
        ///// <summary>
        ///// Width of the poligon
        ///// </summary>
        //public readonly double SizeY;

        ///// <summary>
        ///// Height of the poligon
        ///// </summary>
        ...
        //#region Polygon3D(Double, Int32, PolygonOrientation)
        ...
        //public Polygon3D(double sizeX, double sizeY, double sizeZ, int sides, PolygonOrientation orientation) :
        //    this(sizeX, sizeY, sizeZ, sides, orientation, false) { }

        //#endregion
        //#region Polygon3D(Double, Double, Double, Int32, PolygonOrientation, Boolean)
        ...
        ///// <exception cref="ArgumentOutOfRangeException"><para>
        ///// <paramref name="sizeX"/> is equal to or less than zero.
        ///// </para><para>-or-</para><para>
        ...
        //public Polygon3D(double sizeX, double sizeY, double sizeZ, int sides,
        //    PolygonOrientation orientation, bool vertexNeighbors)
        //{

        //    if (sizeX <= 0.0)
        //        throw new ArgumentOutOfRangeException(
        //            "sizeX", sizeX, Strings.ArgumentNotPositive);

        //    if (sizeY <= 0.0)
        //        throw new ArgumentOutOfRangeException(
        //            "sizeY", sizeY, Strings.ArgumentNotPositive);

        //    if (sizeZ <= 0.0)
        //        throw new ArgumentOutOfRangeException(
        //            "sizeZ", sizeZ, Strings.ArgumentNotPositive);

        //    if (sides < 3)
        //    {
        //        string message = String.Format(CultureInfo.CurrentCulture, Strings.ArgumentLessValue, 3);
        //        throw new ArgumentOutOfRangeException("sides", sides, message);
        //    }
        ...
        //    OuterRadius = sizeX / (2.0 * Math.Sin(segment / 2.0));
        ...
        //            OuterRadius * Math.Cos(angle), OuterRadius * Math.Sin(angle), 0);

        //        Vertices[i+sides] = new Vector3(
        //            OuterRadius * Math.Cos(angle), OuterRadius * Math.Sin(angle), SizeZ);
        //    }
                

        //    // compute and store circumscribed rectangle
        //    Bounds = Box.Circumscribe(Vertices);
        //}
        ...
        //    angle = MathEx.Modulo(angle + 90.0, 360.0);
        ...
        //public Polygon3D Circumscribe(double radius)
        //{
        ...
        //    return new Polygon3D(newLength, SizeY, SizeZ, Sides, Orientation, VertexNeighbors);
        //}
        ...
        //public Polygon3D Circumscribe(double width, double height)
        //{
        //    if (width <= 0.0)
        //        throw new ArgumentOutOfRangeException(
        ...
        //    return new Polygon3D(newLength, Sides, Orientation, VertexNeighbors);
        //}
        ...
        //{
        //    double segment = 360.0 / Connectivity;
        //    double angle = MathEx.Modulo(index, Connectivity) * segment;
        //    if (!HasTopIndex) angle += segment / 2.0;
        //    return MathEx.Modulo(angle - 90.0, 360.0);
        //}
        ...
        ///// of the new <see cref="SizeX"/> to the current value is the same as the ratio of the new
        ...
        //public Polygon3D Inflate(double delta)
        //{
        //    if (delta == 0.0) return this;

        //    if (delta <= -OuterRadius)
        //    {
        //        string message = String.Format(CultureInfo.CurrentCulture, Strings.ArgumentNotGreaterValue, -OuterRadius);
        //        throw new ArgumentOutOfRangeException("delta", delta, message);
        //    }

        //    double newLength = SizeX * (OuterRadius + delta) / OuterRadius;
        //    return new Polygon3D(newLength, SizeY, Sides, Orientation, VertexNeighbors);
        //}
        ...
        //public Polygon3D Inscribe(double radius)
        //{
        ...
        //public Polygon3D Inscribe(double sizeX, double sizeY)
        //{
        //    if (sizeX == Bounds.Width && sizeY == Bounds.Height)
        //        return this;

        //    if (sizeX <= 0.0)
        //        throw new ArgumentOutOfRangeException(
        //            "width", sizeX, Strings.ArgumentNotPositive);

        //    if (sizeY <= 0.0)
        //        throw new ArgumentOutOfRangeException(
        //            "height", sizeY, Strings.ArgumentNotPositive);
        ...
        //        if (Orientation == PolygonOrientation.OnEdge)
        //        {
        //            innerDiameter = sizeY; outerDiameter = sizeX;
        //        }
        //        else
        //        {
        //            innerDiameter = sizeX; outerDiameter = sizeY;
        //        }
        ...
        //        double widthLength = sizeX * radiusFactor / Math.Cos(rightAngle);

        //        double bottomAngle = topAngle + (Sides / 2) * segment;
        //        double heightLength = 2.0 * sizeY * radiusFactor /
        ...
        ///// </summary>
        ///// <param name="length">
        ///// The new value for the <see cref="SizeX"/> property.</param>
        ///// <returns>
        ///// A copy of this <see cref="RegularPolygon"/> instance whose <see cref="SizeX"/> equals
        ...
        ///// <paramref name="length"/> equals the current <see cref="SizeX"/>.
        ///// </para><para>
        ///// Otherwise, <b>Resize</b> creates a new <see cref="RegularPolygon"/> whose <see
        ///// cref="SizeX"/> equals the specified <paramref name="length"/>, and whose other
        ///// properties retain their current values.</para></remarks>

        //public Polygon3D Resize(double length, double height)
        //{
        //    if (length == SizeX) return this;

        //    if (length <= 0.0)
        //        ThrowHelper.ThrowArgumentOutOfRangeException(
        //            "length", length, Strings.ArgumentNotPositive);

        //    return new Polygon3D(length, height, Sides, Orientation, VertexNeighbors);
        //}
