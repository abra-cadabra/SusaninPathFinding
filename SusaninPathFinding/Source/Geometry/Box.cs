...
namespace SusaninPathFinding.Geometry
{
    ...
    /// </para><para>
    /// The <see cref="SusaninPathFinding.Geometry.RectD.Left"/>, <see cref="SusaninPathFinding.Geometry.RectD.Top"/>, <see cref="SusaninPathFinding.Geometry.RectD.Right"/>, and <see
    /// cref="SusaninPathFinding.Geometry.RectD.Bottom"/> properties assume drawing orientation rather than mathematical
    ...
    /// cref="SusaninPathFinding.Geometry.RectD.Width"/> and <see cref="SusaninPathFinding.Geometry.RectD.Height"/> act like the dimensions of a closed
    /// polygon, indicating the greatest coordinates within the <see cref="SusaninPathFinding.Geometry.RectD"/>. Therefore, the
    /// coordinates <see cref="SusaninPathFinding.Geometry.RectD.Right"/> (= <see cref="SusaninPathFinding.Geometry.RectD.Left"/> + <see
    /// cref="SusaninPathFinding.Geometry.RectD.Width"/>) and <see cref="SusaninPathFinding.Geometry.RectD.Bottom"/> (= <see cref="SusaninPathFinding.Geometry.RectD.Top"/> + <see
    /// cref="SusaninPathFinding.Geometry.RectD.Height"/>) are still considered part of the <see cref="SusaninPathFinding.Geometry.RectD"/>.
    /// </para><para>
    ...
    /// cref="Single"/> components. You can convert <see cref="SusaninPathFinding.Geometry.RectD"/> instances to and from <see
    ...
    public class Box : IEquatable<Box>
    {
        ...
        /// <overloads>
        /// Initializes a new instance of the <see cref="SusaninPathFinding.Geometry.RectD"/> structure.</overloads>
        /// <summary>
        /// Initializes a new instance of the <see cref="SusaninPathFinding.Geometry.RectD"/> structure with the specified
        /// <see cref="Double"/> coordinates and dimensions.</summary>
        /// <param name="x">
        /// The smallest <see cref="X"/> coordinate within the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        /// <param name="y">
        /// The smallest <see cref="Y"/> coordinate within the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        /// <param name="width">
        /// The <see cref="SizeX"/> of the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        /// <param name="height">
        /// The <see cref="SizeZ"/> of the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        ...
        ///// <summary>
        ///// Initializes a new instance of the <see cref="SusaninPathFinding.Geometry.RectD"/> structure that contains the
        ///// specified <see cref="PointD"/> coordinates.</summary>
        ///// <param name="point1">
        ///// The first <see cref="PointD"/> that the <see cref="SusaninPathFinding.Geometry.RectD"/> must contain.</param>
        ///// <param name="point2">
        ///// The second <see cref="PointD"/> that the <see cref="SusaninPathFinding.Geometry.RectD"/> must contain.</param>
        ///// <remarks>
        ...
        ///// <param name="location">
        ///// The <see cref="Location"/> of the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        ///// <param name="size">
        ///// The <see cref="Size"/> of the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        ...
        ///// <summary>
        ///// An empty read-only <see cref="SusaninPathFinding.Geometry.RectD"/> instance.</summary>
        ///// <remarks>
        ///// <b>Empty</b> contains a <see cref="SusaninPathFinding.Geometry.RectD"/> instance that was created with the default
        ///// constructor.</remarks>
        ...
        /// <summary>
        /// Gets the coordinates of the upper-left corner of the <see cref="SusaninPathFinding.Geometry.RectD"/>.</summary>
        /// <value>
        ...
        /// <see cref="SusaninPathFinding.Geometry.RectD"/>.</remarks>
        ...
        /// <summary>
        /// Gets the extension of the <see cref="SusaninPathFinding.Geometry.RectD"/>.</summary>
        /// <value>
        /// A <see cref="SizeD"/> containing the <see cref="SizeX"/> and <see cref="SizeZ"/>
        /// dimensions.</value>
        /// <remarks>
        /// The <see cref="SusaninPathFinding.Geometry.RectD"/> covers the area beginning at <see cref="Location"/> and
        ...
        /// <summary>
        /// Circumscribes a <see cref="RectI"/> around the <see cref="SusaninPathFinding.Geometry.RectD"/>.</summary>
        /// <returns>
        /// A <see cref="RectI"/> that entirely covers the <see cref="SusaninPathFinding.Geometry.RectD"/>.</returns>
        /// <remarks>
        ...
        /// dimensions. This ensures that the <see cref="SusaninPathFinding.Geometry.RectD"/> is entirely covered.</remarks>
        ...
        /// <summary>
        /// Circumscribes a <see cref="SusaninPathFinding.Geometry.RectD"/> around the specified <see cref="PointD"/>
        /// coordinates.</summary>
        /// <param name="points">
        /// An <see cref="Array"/> containing the <see cref="PointD"/> coordinates whose bounds to
        /// determine.</param>
        /// <returns>
        /// The smallest <see cref="SusaninPathFinding.Geometry.RectD"/> that contains all specified <paramref name="points"/>.
        /// </returns>
        ...
        /// <overloads>
        /// Indicates whether the <see cref="SusaninPathFinding.Geometry.RectD"/> contains the specified coordinates.
        /// </overloads>
        /// <summary>
        /// Indicates whether the <see cref="SusaninPathFinding.Geometry.RectD"/> contains the specified <see cref="Double"/>
        /// coordinates.</summary>
        /// <param name="x">
        ...
        /// <returns>
        /// <c>true</c> if the <see cref="SusaninPathFinding.Geometry.RectD"/> contains the specified <paramref name="x"/> and
        /// <paramref name="y"/> coordinates; otherwise, <c>false</c>.</returns>
        /// <remarks>
        /// <b>Contains</b> assumes that the <see cref="SusaninPathFinding.Geometry.RectD"/> contains the <see cref="Right"/>
        ...
        ///// <summary>
        ///// Indicates whether the <see cref="SusaninPathFinding.Geometry.RectD"/> contains the specified <see cref="PointD"/>
        ///// coordinates.</summary>
        ///// <param name="point">
        ///// The <see cref="PointD"/> to examine.</param>
        ///// <returns>
        ///// <c>true</c> if the <see cref="SusaninPathFinding.Geometry.RectD"/> contains the specified <paramref name="point"/>;
        ...
        ///// <summary>
        ///// Indicates whether the <see cref="SusaninPathFinding.Geometry.RectD"/> contains the specified rectangle.</summary>
        ///// <param name="rect">
        ///// The <see cref="SusaninPathFinding.Geometry.RectD"/> to examine.</param>
        ///// <returns>
        ///// <c>true</c> if the <see cref="SusaninPathFinding.Geometry.RectD"/> entirely contains the specified <paramref
        ///// name="rect"/>; otherwise, <c>false</c>.</returns>
        ///// <remarks>
        ///// <b>Contains</b> returns <c>true</c> even if both <see cref="SusaninPathFinding.Geometry.RectD"/> instances have a
        ...
        /////// <overloads>
        /////// Indicates whether the <see cref="SusaninPathFinding.Geometry.RectD"/> contains the specified coordinates, excluding
        ...
        /////// <remarks>
        /////// <b>ContainsOpen</b> assumes that the <see cref="SusaninPathFinding.Geometry.RectD"/> does not contain the <see
        ...
        ///// nearest edges of the <see cref="SusaninPathFinding.Geometry.RectD"/>.</summary>
        ///// <param name="q">
        ///// The <see cref="PointD"/> coordinates to examine.</param>
        ///// <returns>
        ///// A <see cref="PointD"/> vector indicating the distance of each <paramref name="q"/> 
        ///// coordinate from the nearest corresponding edge of the <see cref="SusaninPathFinding.Geometry.RectD"/>.</returns>
        ///// <remarks><para>
        ...
        ///// coordinate lies within the corresponding <see cref="SusaninPathFinding.Geometry.RectD"/> extension. Otherwise, the
        ///// component’s absolute value indicates the coordinate’s distance from the nearest <see
        ///// cref="SusaninPathFinding.Geometry.RectD"/> edge, and its sign indicates that edge itself.</para></remarks>
        ...
        /////// <summary>
        /////// Returns the hash code for this <see cref="SusaninPathFinding.Geometry.RectD"/> instance.</summary>
        /////// <returns>
        ...
        ///// <overloads>
        ///// Intersects the <see cref="SusaninPathFinding.Geometry.RectD"/> with the specified object.</overloads>
        ///// <summary>
        ///// Intersects the <see cref="SusaninPathFinding.Geometry.RectD"/> with the specified <see cref="LineD"/>.</summary>
        ///// <param name="line">
        ///// The <see cref="LineD"/> to intersect with the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        ///// <param name="intersection">
        ///// On success, the intersection of the <see cref="SusaninPathFinding.Geometry.RectD"/> and the specified <paramref
        ///// name="line"/>; otherwise, <see cref="LineD.Empty"/>.</param>
        ///// <returns>
        ///// <c>true</c> if the <see cref="SusaninPathFinding.Geometry.RectD"/> intersects with the specified <paramref
        ...
        ///// <summary>
        ///// Intersects the <see cref="SusaninPathFinding.Geometry.RectD"/> with the specified arbitrary polygon.</summary>
        ///// <param name="polygon">
        ///// An <see cref="Array"/> containing <see cref="PointD"/> coordinates that are the vertices
        ///// of the polygon to intersect with the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        ///// <param name="intersection">
        ///// On success, the intersection of the <see cref="SusaninPathFinding.Geometry.RectD"/> and the specified <paramref
        ...
        ///// for an axis-aligned <see cref="SusaninPathFinding.Geometry.RectD"/> as the clipping polygon. At intersection points,
        ///// the border coordinates of the <see cref="SusaninPathFinding.Geometry.RectD"/> are copied rather than computed,
        ...
        ///// the <see cref="SusaninPathFinding.Geometry.RectD"/>.</para></remarks>
        ...
        ///// <summary>
        ///// Intersects the <see cref="SusaninPathFinding.Geometry.RectD"/> with the specified rectangle.</summary>
        ///// <param name="rect">
        ///// The <see cref="SusaninPathFinding.Geometry.RectD"/> to intersect with this instance.</param>
        ///// <param name="intersection">
        ///// On success, the intersection of the <see cref="SusaninPathFinding.Geometry.RectD"/> and the specified <paramref
        ...
        ///// <overloads>
        ///// Determines whether the <see cref="SusaninPathFinding.Geometry.RectD"/> intersects with the specified object.
        ///// </overloads>
        ///// <summary>
        ///// Determines whether the <see cref="SusaninPathFinding.Geometry.RectD"/> intersects with the specified <see
        ///// cref="LineD"/>.</summary>
        ///// <param name="line">
        ...
        ///// <summary>
        ///// Determines whether the <see cref="SusaninPathFinding.Geometry.RectD"/> intersects with the specified rectangle.
        ///// </summary>
        ///// <param name="rect">
        ///// The <see cref="SusaninPathFinding.Geometry.RectD"/> to examine.</param>
        ///// <returns>
        ...
        ///// name="rect"/>; otherwise, <c>false</c>.</returns>
        ///// <remarks>
        ///// <b>IntersectsWith</b> returns <c>true</c> even if both <see cref="SusaninPathFinding.Geometry.RectD"/> instances
        ...
        ///// the <see cref="SusaninPathFinding.Geometry.RectD"/>.</overloads>
        ///// <summary>
        ///// Determines the location of the specified <see cref="PointD"/> coordinates relative to
        ///// the <see cref="SusaninPathFinding.Geometry.RectD"/>, using exact coordinate comparisons.</summary>
        ///// <param name="q">
        ///// The <see cref="PointD"/> coordinates to examine.</param>
        ///// <returns>
        ///// A <see cref="RectLocation"/> value indicating the location of <paramref name="q"/>
        ///// relative to the <see cref="SusaninPathFinding.Geometry.RectD"/>.</returns>
        ///// <remarks>
        ...
        ///// <summary>
        ///// Determines the location of the specified <see cref="PointD"/> coordinates relative to
        ///// the <see cref="SusaninPathFinding.Geometry.RectD"/>, given the specified epsilon for coordinate comparisons.
        ///// </summary>
        ///// <param name="q">
        ///// The <see cref="PointD"/> coordinates to examine.</param>
        ///// <param name="epsilon">
        ...
        ///// <overloads>
        ///// Moves the <see cref="SusaninPathFinding.Geometry.RectD"/> by the specified offset.</overloads>
        ///// <summary>
        ///// Moves the <see cref="SusaninPathFinding.Geometry.RectD"/> by the specified <see cref="Double"/> values.</summary>
        ///// <param name="x">
        ///// The horizontal offset applied to the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        ///// <param name="y">
        ///// The vertical offset applied to the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        ///// <returns>
        ///// A new <see cref="SusaninPathFinding.Geometry.RectD"/> with the same <see cref="Size"/> as this instance, and whose
        ...
        ///// <summary>
        ///// Moves the <see cref="SusaninPathFinding.Geometry.RectD"/> by the specified <see cref="PointD"/> vector.</summary>
        ///// <param name="vector">
        ///// A <see cref="PointD"/> value whose components define the horizontal and vertical offset
        ///// applied to the <see cref="SusaninPathFinding.Geometry.RectD"/>.</param>
        ///// <returns>
        ///// A new <see cref="SusaninPathFinding.Geometry.RectD"/> with the same <see cref="Size"/> as this instance, and whose
        ...
        ///// <summary>
        ///// Converts the <see cref="SusaninPathFinding.Geometry.RectD"/> to a <see cref="RectI"/> by rounding coordinates and
        ...
        ///// cref="SusaninPathFinding.Geometry.RectD"/>, rounded to the nearest <see cref="Int32"/> values.</returns>
        ///// <remarks>
        ///// The <see cref="Double"/> components of the <see cref="SusaninPathFinding.Geometry.RectD"/> are converted to <see
        ...
        ///// <summary>
        ///// Returns a <see cref="String"/> that represents the <see cref="SusaninPathFinding.Geometry.RectD"/>.</summary>
        ///// <returns>
        ...
        ///// <summary>
        ///// Determines the union of the <see cref="SusaninPathFinding.Geometry.RectD"/> and the specified rectangle.</summary>
        ///// <param name="rect">
        ///// The <see cref="SusaninPathFinding.Geometry.RectD"/> to combine with this instance.</param>
        ///// <returns>
        ///// A <see cref="SusaninPathFinding.Geometry.RectD"/> that contains the union of the specified <paramref name="rect"/>
        ...
        /// <summary>
        /// Determines whether two <see cref="SusaninPathFinding.Geometry.RectD"/> instances have the same value.</summary>
        /// <param name="a">
        /// The first <see cref="SusaninPathFinding.Geometry.RectD"/> to compare.</param>
        /// <param name="b">
        /// The second <see cref="SusaninPathFinding.Geometry.RectD"/> to compare.</param>
        /// <returns>
        /// <c>true</c> if the value of <paramref name="a"/> is the same as the value of <paramref
        /// name="b"/>; otherwise, <c>false</c>.</returns>
        /// <remarks>
        /// This operator invokes the <see cref="Equals(SusaninPathFinding.Geometry.RectD)"/> method to test the two <see
        /// cref="SusaninPathFinding.Geometry.RectD"/> instances for value equality.</remarks>
        ...
        /// <summary>
        /// Determines whether two <see cref="SusaninPathFinding.Geometry.RectD"/> instances have different values.</summary>
        /// <param name="a">
        /// The first <see cref="SusaninPathFinding.Geometry.RectD"/> to compare.</param>
        /// <param name="b">
        /// The second <see cref="SusaninPathFinding.Geometry.RectD"/> to compare.</param>
        ...
        /// <remarks>
        /// This operator invokes the <see cref="Equals(SusaninPathFinding.Geometry.RectD)"/> method to test the two <see
        /// cref="SusaninPathFinding.Geometry.RectD"/> instances for value inequality.</remarks>
        ...
        /// <overloads>
        /// Determines whether two <see cref="SusaninPathFinding.Geometry.RectD"/> instances have the same value.</overloads>
        /// <summary>
        /// Determines whether this <see cref="SusaninPathFinding.Geometry.RectD"/> instance and a specified object, which must
        /// be a <see cref="SusaninPathFinding.Geometry.RectD"/>, have the same value.</summary>
        /// <param name="obj">
        /// An <see cref="Object"/> to compare to this <see cref="SusaninPathFinding.Geometry.RectD"/> instance.</param>
        /// <returns>
        /// <c>true</c> if <paramref name="obj"/> is another <see cref="SusaninPathFinding.Geometry.RectD"/> instance and its
        /// value is the same as this instance; otherwise, <c>false</c>.</returns>
        /// <remarks>
        /// If the specified <paramref name="obj"/> is another <see cref="SusaninPathFinding.Geometry.RectD"/> instance,
        /// <b>Equals</b> invokes the strongly-typed <see cref="Equals(SusaninPathFinding.Geometry.RectD)"/> overload to test
        ...
        /// <summary>
        /// Determines whether this instance and a specified <see cref="SusaninPathFinding.Geometry.RectD"/> have the same
        /// value.</summary>
        /// <param name="box">
        /// A <see cref="SusaninPathFinding.Geometry.RectD"/> to compare to this instance.</param>
        /// <returns>
        ...
        /// cref="SizeX"/>, and <see cref="SizeZ"/> properties of the two <see cref="SusaninPathFinding.Geometry.RectD"/>
        ...
        /// <summary>
        /// Determines whether two specified <see cref="SusaninPathFinding.Geometry.RectD"/> instances have the same value.
        /// </summary>
        /// <param name="a">
        /// The first <see cref="SusaninPathFinding.Geometry.RectD"/> to compare.</param>
        /// <param name="b">
        ...
        /// name="b"/>; otherwise, <c>false</c>.</returns>
        /// <remarks>
        /// <b>Equals</b> invokes the non-static <see cref="Equals(SusaninPathFinding.Geometry.RectD)"/> overload to test the
        /// two <see cref="SusaninPathFinding.Geometry.RectD"/> instances for value equality.</remarks>
