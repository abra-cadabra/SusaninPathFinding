...
{
    [Serializable]
    public class Vector3 : IComparable, IComparable<Vector3>, IEquatable<Vector3>, IFormattable, ICloneable
    {
        ...
        /// </exception>
        /// <Acknowledgement>This code is adapted from Exocortex - Ben Houston </Acknowledgement>
        public static void Normalize(Vector3 v1)
        {
        ...
        public static Vector3 CreateNormalized(Vector3 v1)
        {
            Vector3 norm = (Vector3)v1.Clone();
            norm.Normalize();
        ...
        public static double Angle(Vector3 v1, Vector3 v2)
        {
            ...
            (
                Math.Acos
                    (
                        CreateNormalized(v1).DotProduct(CreateNormalized(v2))
                    )
            );
        }
        ...
        public static void Yaw(Vector3 v1, double degree)
        {
        ...
        public static void Pitch(Vector3 v1, double degree)
        {
            double x = v1.X;
        ...
        public static void Roll(Vector3 v1, double degree)
        {
        ...
        {
            //Vector3 tmp = (Normalize(this) - (normal * 2 * Normalize(this).DotProduct(normal))) * Magnitude;
            //return tmp * this;
            throw new NotImplementedException();
        }

        /// <summary>
        /// Rotate vector on an angle around the axis
        /// </summary>
        ...
        public static Vector3 Rotate(Vector3 v, Vector3 axis, double angle)
        {
            ...
            double a1 = (tr * axis.X * axis.X) + cos;
            double a2 = (tr * axis.X * axis.Y) - (sin * axis.Z);
            double a3 = (tr * axis.X * axis.Z) + (sin * axis.Y);
            double b1 = (tr * axis.X * axis.Y) + (sin * axis.Z);
            double b2 = (tr * axis.Y * axis.Y) + cos;
            double b3 = (tr * axis.Y * axis.Z) - (sin * axis.X);
            double c1 = (tr * axis.X * axis.Z) - (sin * axis.Y);
            double c2 = (tr * axis.Y * axis.Z) + (sin * axis.X);
            double c3 = (tr * axis.Z * axis.Z) + cos;
        ...
        public static void PowComponents(Vector3 v1, double power)
        {
            v1.X = Math.Pow(v1.X, power);
            v1.Y = Math.Pow(v1.Y, power);
            v1.Z = Math.Pow(v1.Z, power);
            //return
            //(
            //    new Vector3
            //        (
        ...
        public static void SqrtComponents(Vector3 v1)
        {
            v1.X = Math.Sqrt(v1.X);
            v1.Y = Math.Sqrt(v1.Y);
            v1.Z = Math.Sqrt(v1.Z);
        ...
        public static void SqrComponents(Vector3 v1)
        {
            v1.X = v1.X*v1.X;
            v1.Y = v1.Y*v1.Y;
            v1.Z = v1.Z*v1.Z;
