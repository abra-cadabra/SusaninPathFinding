...
namespace SusaninPathFinding.Graph
{
    ...
    public interface ITraversalStrategy<T>
    {
        ...
        /// <summary>
        /// Indicates whether the <see cref="ITraversalStrategy{T}"/> can enter <see cref="IGraph2D{TNode}"/>
        /// nodes that exceed the maximum path cost for a movement.</summary>
        /// <value>
        /// <c>true</c> if the <see cref="ITraversalStrategy{T}"/> may end a movement on an <see
        ...
        /// cref="ITraversalStrategy{T}"/> will not enter any node whose total path cost exceeds this
        ...
        /// <summary>
        /// Determines whether the <see cref="ITraversalStrategy{T}"/> can move from one specified <see
        ...
        /// <returns>
        /// <c>true</c> if the <see cref="ITraversalStrategy{T}"/> can move from <paramref name="source"/>
        ...
        /// <remarks><para>
        /// <b>CanMakeStep</b> should only consider whether the <see cref="ITraversalStrategy{T}"/> could
        ...
        /// <summary>
        /// Determines whether the <see cref="ITraversalStrategy{T}"/> can permanently occupy the specified
        /// <see cref="IGraph2D{TNode}"/> node.</summary>
        /// <param name="target">
        /// The <see cref="IGraph2D{TNode}"/> node to occupy.</param>
        /// <returns>
        /// <c>true</c> if the <see cref="ITraversalStrategy{T}"/> can permanently occupy <paramref
        /// name="target"/>; otherwise, <c>false</c>.</returns>
        /// <exception cref="ArgumentException">
        /// <paramref name="target"/> is not a valid <see cref="IGraph2D{TNode}"/> node.</exception>
        /// <remarks><para>
        /// <b>CanOccupy</b> should consider whether the <see cref="ITraversalStrategy{T}"/> could
        ...
        /// <summary>
        /// Returns the cost for moving the <see cref="ITraversalStrategy{T}"/> from one specified <see
        /// cref="IGraph2D{TNode}"/> node to another neighboring node.</summary>
        /// <param name="source">
        /// The <see cref="IGraph2D{TNode}"/> node where the move starts.</param>
        /// <param name="target">
        ...
        /// <paramref name="source"/>.</param>
        /// <returns>
        /// The cost for moving the <see cref="ITraversalStrategy{T}"/> from <paramref name="source"/> to
        ...
        /// cref="IGraph2D{TNode}"/> nodes.</exception>
        /// <remarks><para>
        /// <b>GetStepCost</b> should not attempt to verify that the <see cref="ITraversalStrategy{T}"/>
        ...
        /// the <see cref="ITraversalStrategy{T}"/> should calculate the distance.</param>
        /// <returns>
        ...
        /// <summary>
        /// Determins whether the <see cref="ITraversalStrategy{T}"/> can pass through <see
        /// cref="IGraph{T}"/> node at all.</summary>
        /// <param name="target">
        /// The <see cref="IGraph{T}"/> node which is under test.
        /// </param>
        /// <returns>
        /// <c>true</c> if node is passable by the <see cref="ITraversalStrategy{T}"/>;
        /// otherwise, <c>false</c>.
        /// </returns>
